...
contract InceptionOmniVault is IInceptionOmniVault, InceptionOmniAssetsHandler {
    ...
    /// @dev Reference to the CrossChainAdapter
    ...
    event DepositedToLiquidPool(address indexed sender, uint256 amount);
    ...
    receive() external payable {
        ...
        // Automatically call deposit function of LiquidPool via CrossChainAdapter
        CrossChainAdapter.depositToLiquidPool{value: amount}(msg.sender, amount);

        emit DepositedToLiquidPool(msg.sender, amount);
    }
